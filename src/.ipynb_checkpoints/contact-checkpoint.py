...
def show():
    with st.container(border=True):
        ...
        github_url = "https://github.com/bharathyamsani"
        ...
        with col2:
            col2=Container("Ram Praneeth Reddy","saibharathyamsani@gmail.com",github_url)
        with col3:
            col3=Container("Sai Shashank Harish","saibharathyamsani@gmail.com",github_url)